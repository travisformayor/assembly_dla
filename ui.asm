...
.data
    ...
    ; DLA Symbols
    stuckSymbol BYTE "o"                        ; Text char used for stuck particles
    unstuckSymbol BYTE "."                      ; Text char used for unstuck particles
...
; Registers:
;   EAX - Calculations and sending the buffer to write_string
;   ECX - Loop counter for filling the buffer and adding borders
;   EDI - Hold address for the screenBuffer
;   ESI - Calculating linear index for the buffer
...
; Description:
;   Includes a particle into the screenBuffer at its current location and
;   with a symbol indicating its status (stuck or unstuck)
